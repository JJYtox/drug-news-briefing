...
RSS_URL = (
    ...
    "+AND+(site:yna.co.kr+OR+site:kbs.co.kr+OR+site:imbc.com"
    "+OR+site:sbs.co.kr+OR+site:ytn.co.kr+OR+site:jtbc.co.kr"
    "+OR+site:chosun.com+OR+site:joongang.co.kr+OR+site:donga.com)"
